...
function Invite() {
  ...
  useEffect(() => {
    validateInvite(token)
      .then(setInviteData)
      .catch((err) => setInvalidMessage(err.message))
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const data = await register(token, name, password);
    ...
    return (
      <div className="invite-page">
        <div className="invite-card text-center">
          ...
          <p className="text-muted">{invalidMessage}</p>
    ...
    <div className="invite-page">
      <div className="invite-card">
        <div className="invite-header">
          ...
          <p>
            Join <strong>{inviteData.workspaceName}</strong>
          </p>
        </div>
